...
- Use an explicit trainee roster for each run. A recurring schedule has a template roster that is copied to future occurrences. Standalone quizzes remain assignment-based; course assessments continue to be governed by the enrolled course.
