...
The trainee Overview currently opens on a Course tab with featured course cards and category shortcuts. The remaining overview tabs are intentionally reserved for their later designs and workflows.
