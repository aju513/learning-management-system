...
<div class="grid gap-6 xl:grid-cols-[1fr_320px]">
    <div class="space-y-6">
        ...
        @else
            <p class="rounded-xl border border-warning-200 bg-warning-50 p-4 text-sm text-warning-700">Questions are locked because {{ $assessment->started_attempts ?? 0 }} attempt(s) have started this assessment.</p>
        @endif
    </div>
