...
<body class="min-h-full bg-gray-50 text-gray-800 dark:bg-gray-950 dark:text-white">
    ...
    @endif
    @if ($errors->any())
        <div class="fixed left-1/2 top-5 z-50 w-[min(92vw,520px)] -translate-x-1/2 rounded-xl border border-error-500/30 bg-error-50 px-4 py-3 text-sm text-error-700 shadow-theme-lg dark:bg-error-500/15 dark:text-error-400">
            {{ $errors->first() }}
        </div>
    @endif
