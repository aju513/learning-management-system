                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    @foreach($applications as $application)
                        <tr class="align-middle">
                            ...
                            <td class="px-4 py-4"><x-ui.badge :color="$application->status->value === 'pending' ? 'warning' : ($application->status->value === 'rejected' ? 'error' : 'light')">{{ ucfirst($application->status->value) }}</x-ui.badge></td>
