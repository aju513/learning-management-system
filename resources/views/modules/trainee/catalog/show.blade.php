                ...
                @else
                    @if($progress)
                        ...
                        @if($progress['assessment'] && ! $progress['assessmentPassed'] && $progress['assessmentStatus'] === 'Available')
                            <a href="{{ route('learning.courses.player', $application) }}" class="block rounded-lg bg-brand-500 px-4 py-3 text-center text-sm font-medium text-white">Continue course</a>
