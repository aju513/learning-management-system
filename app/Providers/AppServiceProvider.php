...
use App\Repositories\Eloquent\CreditScoreViewerRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(CreditScoreViewerRepositoryInterface::class, CreditScoreViewerRepository::class);
    ...
    {
        Blade::anonymousComponentNamespace('modules.trainee.components', 'trainee');
