...
return [
    ...
    'roles' => [
        'admin' => [
            ...
            'assessments.manage', 'assessments.show', 'assessments.view-all',
            'results.manage', 'results.view-all', 'reports.view',
        ],
        'instructor' => [
            ...
            'assessments.manage', 'assessments.show', 'assessments.create', 'assessments.edit', 'assessments.delete', 'assessments.publish', 'assessments.assign',
            'results.manage', 'results.view-owned',
        ],
        'trainee' => [
